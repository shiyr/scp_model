...
class MasterProblem(object):
    def __init__(self, data):
        ...
        self.demands = self.data.demands # get first stage demand
        self.yields = self.data.yields # get first stage yield
    ...
    def _build_model(self):
        ...
        self.demand_constraints = get_demand_constraints(self.model, self.demands,
